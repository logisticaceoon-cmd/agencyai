  ...
  return (
    <section id="testimonios" className="py-24 px-4 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl" ref={ref}>
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-purple-500/10 border border-purple-500/20 px-4 py-1.5 text-sm text-purple-400 mb-6">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900/70 p-8 sm:p-12 backdrop-blur-sm relative overflow-hidden">
            {/* Quote icon */}
            <Quote className="absolute top-6 right-6 h-16 w-16 text-zinc-800/50" />
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white font-bold text-sm">
                      {t.avatar}
                    </div>
                    <div>
                  ...
                  <div className="hidden sm:block rounded-full bg-green-500/10 border border-green-500/20 px-4 py-2">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button
              onClick={prev}
              className="h-10 w-10 rounded-full border border-zinc-700 bg-zinc-900 flex items-center justify-center text-zinc-400 hover:text-white hover:border-zinc-600 transition-all"
            >
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all ${
                    i === current ? 'w-8 bg-indigo-500' : 'w-2 bg-zinc-700 hover:bg-zinc-600'
                  }`}
                />
              ))}
            </div>
