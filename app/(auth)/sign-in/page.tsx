...
import { Eye, EyeOff, Zap, Mail, ArrowLeft } from 'lucide-react'
...
export default function SignInPage() {
  ...
  async function handleForgotPassword(e: React.FormEvent) {
    ...
    try {
      ...
      if (error) {
        setForgotError('No pudimos procesar la solicitud. Verificá el email ingresado.')
      } else {
        setView('forgot-sent')
      }
    } catch {
          ...
          {view === 'forgot-sent' && (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-slate-500 mb-2">
                Revisá tu bandeja de entrada en <strong>{forgotEmail}</strong> y hacé click en el link para restablecer tu contraseña.
              </p>
              <p className="text-xs text-slate-400 mb-6">¿No lo ves? Revisá la carpeta de spam.</p>
              <button
                type="button"
